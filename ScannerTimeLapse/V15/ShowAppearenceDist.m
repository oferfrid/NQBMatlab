function ShowAppearenceDist(TimeAxis ,TotalAppearenceMinute, FileDir, bin)
%ShowAppearenceDist(TimeAxis ,TotalDistr, FileDir)

figure; 
TimeAxis = TimeAxis(1:bin:end);
hist(TotalAppearenceMinute,TimeAxis);
