...
%
% Purpose: Calculates the relative motions in a sequence of images
%       uses Translation or Rotation+translation
% Arguments: basseImageName - base filename path (in sprintf style)
...
% Returns:motions (when using 'trans') - a matrix of length(imageIndices)x2, 
%       each row contains the [u v] translation relative to the previous image. 
%       The first row is [0 0]
%       motions (when using 'transrot') - a cell-array that contains
%       2d-transformation matrices. the transformation matrix between the 
%       3rd and the 4th images will be in motions{4}.
